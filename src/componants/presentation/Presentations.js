...
function Presentatons() { 
    return(
        <div class="presentatons">
            <div class="title_presentatons">
                <h2>Projets</h2>
            </div>
            <div class="content_presentatons">
                <div class="presentaton">
                    <h3>Template Quote Generator</h3>
                    <div class="content_presentaton"> 
                        <p>Développement d'une page permettant d'afficher aléatoirement une citation. Réalisé avec :</p>
                        <ul class="langages_presentaton">
